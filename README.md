...
beetRoot is a rapid Java web-development as well as a full & secure client-server framework ready to run and starts approx. 5 times faster than [SpringBoot](https://spring.io/guides/gs/spring-boot) 
