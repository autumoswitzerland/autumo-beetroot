...
**The client-server framework is not documented in this document; it focuses only on the web development part. Furthermore, take a look at the [Javadoc API](doc/apidocs/index.html).**
<br />
<br />
