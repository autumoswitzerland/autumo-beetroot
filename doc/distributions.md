...
3. **`beetroot-jetty.war`**: Jetty package.
...
For instructions on setting up and running beetRoot on any platform and web container (Tomcat, Jetty and WebLogic), see [Running](running.md).
