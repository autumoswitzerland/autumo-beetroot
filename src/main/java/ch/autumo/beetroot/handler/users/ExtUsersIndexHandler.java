 ...
 */
public class ExtUsersIndexHandler extends UsersIndexHandler {

	public ExtUsersIndexHandler(String entity) {
		super(entity);
	}

	public ExtUsersIndexHandler(String entity, String msg) {
		super(entity, msg);
	}
