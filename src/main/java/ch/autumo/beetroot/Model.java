	...
	public String get(String fieldName) {
		...
		while (clz != null) {
			try {
				...
				if (clz == null)
					LOG.error("Couldn't get property '"+fieldName+"' from bean class '"+modelClass().getName()+"'!", e); // no value
			}
		}
