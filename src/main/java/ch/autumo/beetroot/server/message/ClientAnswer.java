...
public class ClientAnswer extends AbstractMessage {
	 ...
	 * Client answer.
	 * 
	 * The answer can have parts, separated by '|'.
	 * 
	 * @param answer answer
	 */
	 ...
	 * 
	 * @param answer answer
	 * @param fileId file ID of uploaded file generated by a file server
	 */
	 ...
	 * 
	 * @param answer answer
	 * @param entity entity name of served/looked-up entity
	 * @param id id name of served/looked-up entity
	 */
	 ...
	 * @param entity entity name of served/looked-up entity
	 * @param id id name of served/looked-up entity
	 * @param errorReason if there's an error
	 */
	...
	public static ClientAnswer parse(String transferString) throws IOException {
		...
		final String parts [] = transferString.split(MSG_PART_SEPARATOR_REGEXP, 7);
